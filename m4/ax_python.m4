...
#
#   It recurses through several python versions (from 3.6 to 2.6 in this
...
AC_MSG_RESULT([])
for python in python3.6 python3.5 python3.4 python3.3 python3.2 python3.1 python3.0 python2.7 python2.6 python; do
